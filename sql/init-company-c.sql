CREATE DATABASE siamtemp_company_c;
\c siamtemp_company_c;
...
CREATE TABLE skills (
    id SERIAL PRIMARY KEY,
    name VARCHAR(100) NOT NULL UNIQUE,
    category VARCHAR(50), -- 'tempnical', 'soft', 'language', 'certification', 'international'
    description TEXT,
    is_active BOOLEAN DEFAULT true,
...
CREATE TABLE training (
    ...
    category VARCHAR(100), -- 'tempnical', 'soft_skills', 'certification', 'compliance', 'cross_cultural', 'language'
    start_date DATE NOT NULL,
...
('MegaCorp International', 'tempnology', 'John Smith', 'john.smith@megacorp.com', '+1-555-0123', 'New York, NY', 'USA', 'America/New_York', 'USD', 2800000.00, 2800000.00, 'global', 'en'),
...
('PayGlobal Ltd', 'Fintemp', 'Emma Williams', 'emma@payglobal.com', '+61-2-1234-5678', 'Sydney, Australia', 'Australia', 'Australia/Sydney', 'AUD', 2400000.00, 1800000.00, 'international', 'en'),
('temp Solutions Europe', 'tempnology Consulting', 'Andreas Mueller', 'andreas@tempsolutions.de', '+49-30-12345678', 'Berlin, Germany', 'Germany', 'Europe/Berlin', 'EUR', 3500000.00, 3850000.00, 'international', 'en');

-- Insert International Skills
INSERT INTO skills (name, category, description, global_demand_level) VALUES
-- International tempnical Skills
('React', 'tempnical', 'Modern frontend library', 'high'),
('Node.js', 'tempnical', 'JavaScript runtime for backend', 'high'),
('TypeScript', 'tempnical', 'Typed JavaScript for large applications', 'high'),
('Microservices Architecture', 'tempnical', 'Distributed system design', 'critical'),
('AWS Cloud Architecture', 'tempnical', 'Enterprise cloud solutions', 'critical'),
('Docker & Kubernetes', 'tempnical', 'Container orchestration', 'high'),
('GraphQL', 'tempnical', 'Modern API development', 'medium'),
('Blockchain Development', 'tempnical', 'Distributed ledger tempnology', 'high'),
('AI/ML Integration', 'tempnical', 'Artificial Intelligence implementation', 'critical'),
('DevOps & CI/CD', 'tempnical', 'Continuous integration and deployment', 'high'),
...
('Advanced Microservices Architecture', 'Enterprise microservices patterns', 'Cloud Native Foundation', 'tempnical', '2024-08-10', '2024-08-14', 35, 2500.00, 'USD', 2500.00, 'Online', 'UTC', 'online', 'en', true),
...
('Alex Johnson', 'IT', 'Senior Full Stack Developer', 85000.00, '2022-03-15', 'alex.johnson@siamtemp-intl.com'),
('Sarah Chen', 'IT', 'Frontend Developer', 65000.00, '2022-05-20', 'sarah.chen@siamtemp-intl.com'),
('Michael Kim', 'IT', 'DevOps Engineer', 75000.00, '2022-04-10', 'michael.kim@siamtemp-intl.com'),
('Emma Wilson', 'IT', 'UI/UX Designer', 60000.00, '2022-06-15', 'emma.wilson@siamtemp-intl.com'),
('David Rodriguez', 'IT', 'Backend Developer', 70000.00, '2022-07-01', 'david.rodriguez@siamtemp-intl.com'),

-- Sales Department (2 people)
('Jessica Brown', 'Sales', 'International Sales Manager', 80000.00, '2022-03-01', 'jessica.brown@siamtemp-intl.com'),
('Robert Lee', 'Sales', 'Business Development', 55000.00, '2022-08-15', 'robert.lee@siamtemp-intl.com'),

-- Management (1 person)
('Linda Taylor', 'Management', 'International Director', 120000.00, '2022-02-15', 'linda.taylor@siamtemp-intl.com');

-- Insert Company C projects (International projects)
INSERT INTO projects (name, client, budget, status, start_date, end_date, temp_stack) VALUES
...
SELECT 
    ...
    AVG(es.proficiency_level) FILTER (WHERE s.category = 'tempnical') as avg_tempnical_level
FROM employees e
...
COMMENT ON DATABASE siamtemp_company_c IS 'Siamtemp International Office Database - Global Operations';
COMMENT ON TABLE employees IS 'International team members';
COMMENT ON TABLE projects IS 'Global and international projects';
COMMENT ON DATABASE siamtemp_company_c IS 'Siamtemp International Office Database - Global Operations with Multi-Currency Support';
...
('Siamtemp International', 'International Office', 'Bangkok, Thailand (Global Operations)', 8, '2022-02-15', 'International division of Siamtemp Co., Ltd. focusing on global clients and cross-border tempnology solutions');
